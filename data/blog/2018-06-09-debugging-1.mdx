...
date: '2018-06-09'
summary: Key steps in fixing problems in front-end code
tags: ['how-to', 'debugging']
---

![Debugging](/static/images/debugging1.jpg)
...
Over my time working on front-end code I've come up with a few methods to make debugging _slightly_ less painful; in this four-post series I'll share some of the most valuable tips and tricks I've picked up to help with the debugging process.
